...
# Standard Bedrock model id used across this codebase
CLAUDE_4_SONNET = 'us.anthropic.claude-sonnet-4-20250514-v1:0'
CLAUDE_3_5_HAIKU = CLAUDE_4_SONNET
CLAUDE_3_5_SONNET = CLAUDE_4_SONNET
...
#        ...
# 
#     with use_model(eval_model=CLAUDE_3_5_HAIKU):
#        ...
@contextmanager
